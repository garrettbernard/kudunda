...
if (!$error && ($size[0] < 25) || ($size[1] < 25))
{
	$error = 'Please upload an image bigger than 25px.';
		...
		print("SESSION ID:" . $_SESSION['id']);
 		$sql    = "SELECT * FROM pictures WHERE uploader_id = '1' ORDER BY id DESC";
...
// move_uploaded_file($_FILES['Filedata']['tmp_name'], 'c:/apache2/htdocs/kudunda/pictures/' . $_SESSION['id'] . '_' . $numrow );
